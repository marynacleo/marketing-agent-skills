---
name: business-roi
description: Evaluate a business idea, new service, offer, product, lead magnet, or side project BEFORE building it - who pays, for what value, why now, full cost in hours, scalability, burnout risk, and the cheapest real-market test. Use when the user proposes a new idea or asks "стоит ли / worth it / should I build". Do NOT use for executing already-validated plans or for pure marketing execution of an existing offer.
---
