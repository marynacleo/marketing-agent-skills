...
description: >-
  Strategic pre-writing process for any brand/marketing content. Use BEFORE
  writing a LinkedIn post, landing page, "À propos" / About page, brand story,
  positioning line, persona, email, offer, or campaign copy. Enforces
  message-first architecture (goal → person → emotion → message → story →
  channel → check), pain-based personas (not demographic theatre), and using AI
  as interviewer + critic rather than a text generator. Triggers on: brand
  story, storytelling, positioning, persona, buyer persona, personal brand,
  fil rouge, "help me write my story", LinkedIn strategy, offer messaging.
---
